class MypagesController < ApplicationController
  ...
  before_action :set_url, only: [:listing, :in_progress, :completed]
  ...
  def sidebar_setteing
    ...
    @linklist = ["/mypage", "/info/", "/mustdo/", "/liles_all/", "/出品する/", "/mypage/listings/listing", "/mypage/listings/in_progress", "/mypage/listings/completed"]
