$(document).on("turbolinks:load", function() {
  ...
  function judgeBrand(id) {
    if (20 <= id && id <= 85) {
      ...
      return true;
    } else if (150 <= id && id <= 183) {
      return true;
    } else if (190 <= id && id <= 262) {
      return true;
    } else if (338 <= id && id <= 352) {
      return true;
    } else if (375 <= id && id <= 403) {
      return true;
    } else if (408 <= id && id <= 435) {
      return true;
    } else if (440 <= id && id <= 469) {
      return true;
    } else if (474 <= id && id <= 495) {
      return true;
    } else if (537 <= id && id <= 567) {
      return true;
    } else {
      return false;
    }
